...
> **最終更新**: 2026-03-15
> **現在フェーズ**: Phase A 完了・Phase B 開始済み（AIトリアージ実装済み）
...
| 実装済みAPI | Incident / Change / Problem / ServiceRequest / CMDB / SLA / Webhook / Auth |
| AI機能 | AIトリアージ（キーワードベース）実装済み・LLMプロバイダー切替対応 |
